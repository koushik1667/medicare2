...
const PatientLayout: React.FC = () => {
  ...
  const menuItems = [
    { path: '/patient', label: t('navHome'), icon: <Home /> },
    { path: '/patient/symptom-submit', label: t('navSymptomSubmit'), icon: <AddCircle /> },
    ...
    { path: '/patient/fraud-detection', label: t('navFraudDetection'), icon: <Security /> },
    { path: '/patient/medical-records', label: t('navMedicalRecords'), icon: <MedicalServices /> },
    { path: '/patient/profile', label: t('navProfile'), icon: <Person /> },
  ];
        ...
        <Stack direction="row" spacing={1.5} alignItems="center">
          <Box
            sx={{
              ...
              boxShadow: '0 4px 12px rgba(93, 112, 82, 0.25)',
            }}
          >
            <Spa fontSize="small" />
          </Box>
          ...
          <ListItem key={item.path} disablePadding sx={{ mb: 0.75 }}>
            <ListItemButton
              ...
              sx={{
                ...
                '&:hover:not(.active)': {
                  bgcolor: 'rgba(93, 112, 82, 0.08)',
                },
              }}
            >
              <ListItemIcon sx={{ minWidth: 38, color: '#5D7052' }}>{item.icon}</ListItemIcon>
              <ListItemText
                primary={item.label}
      ...
      >
        <Toolbar sx={{ justifyContent: 'space-between' }}>
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            >
              <Avatar sx={{ bgcolor: '#5D7052', color: '#fff', width: 34, height: 34, fontSize: '0.9rem' }}>
          ...
          >
            <MenuItem onClick={() => { navigate('/patient/profile'); handleMenuClose(); }} sx={{ fontWeight: 600 }}>
              {t('navProfile')}
            </MenuItem>
