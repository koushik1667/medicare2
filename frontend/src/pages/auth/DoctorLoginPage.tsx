  ...
  if (isLoading) {
    return (
      <Box display="flex" justifyContent="center" alignItems="center" height="100vh" bgcolor="#FDFCF8">
        <CircularProgress sx={{ color: '#C18C5D' }} />
      </Box>
    );
  }
      ...
      <Container maxWidth="sm" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={4}>
          <Button
            ...
            to="/"
            startIcon={<ArrowBack />}
            sx={{ color: '#C18C5D', fontWeight: 700 }}
          >
            Portal Select
          </Button>
          <LanguageSelector />
        ...
        <Paper
          ...
          sx={{
            ...
            boxShadow: '0 12px 40px -6px rgba(193, 140, 93, 0.15)',
          }}
        >
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              Physician & Specialist Portal for clinical triage and digital prescription review
            </Typography>
          </Box>
          ...
          <Box component="form" onSubmit={handleSubmit(onSubmit)}>
            <TextField
              ...
              {...register('email', {
                required: 'Please enter doctor email address',
              })}
              error={!!errors.email}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    disabled={isSubmitting}
                    sx={{ color: '#C18C5D', '&.Mui-checked': { color: '#C18C5D' } }}
                  />
                }
            ...
            <GoogleSignInButton
              label="Doctor Sign In with Google"
              role="doctor"
