...
import PrescriptionScanner from './pages/patient/PrescriptionScanner';
import PrescriptionTranslator from './pages/patient/PrescriptionTranslator';
              ...
              <AuthProvider>
                <ErrorBoundary>
                  <Routes>
                    ...
                    <Route path="/doctor-register" element={<Navigate to="/login" replace />} />
